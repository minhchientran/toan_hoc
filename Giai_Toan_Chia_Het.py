...
class giai_toan_chia_het(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Nguyễn Văn Sang-THPT Nguyễn Hữu Cảnh-TP HCM")
    ...
    def calculate6(self):
        ...
        if count == 2:
            ...
            if so_dung and gan_dung:
                ...
                sai_so_tuong_doi_a = float(sai_so_tuyet_doi) / float(gan_dung)
